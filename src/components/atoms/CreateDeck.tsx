...
type CreateFolderProps = {
  handleCreate: (formData: { name: string; desc: string }) => void;
};

export default function CreateDeck({ handleCreate }: CreateFolderProps) {
  ...
  return (
    <form
      ...
      className="grid grid-cols-[164px_1fr_1fr] border-2 rounded-md max-w-[600px]"
    >
